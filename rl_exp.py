...
env.continuous_running(dispatchs=dispatch_list_for_fixed_need,instant_orders_dispatcher=raw_data_dispatch.external_method_for_random_need,reposition_method=agent.take_action_max_prob)